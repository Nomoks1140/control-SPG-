...
<strong>Error !</strong> Contraseña de al menos 6 caracteres !</div>';
      ...
      $msg = '<div class="alert alert-danger alert-dismissible mt-3" id="flash-msg">
<a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
<strong>Error !</strong> nuestra contraseña debe contener al menos 1 número !</div>';
        return $msg;
    }elseif(!preg_match("#[a-z]+#",$password)) {
      $msg = '<div class="alert alert-danger alert-dismissible mt-3" id="flash-msg">
<a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
...
<strong>Error !</strong> El correo electrónico ya existe, intente con otro correo electrónico ... !</div>';
      ...
      if ($result) {
        $msg = '<div class="alert alert-success alert-dismissible mt-3" id="flash-msg">
  <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
  <strong>Success !</strong> Vaya, te has registrado correctamente !</div>';
          return $msg;
      }else{
        $msg = '<div class="alert alert-danger alert-dismissible mt-3" id="flash-msg">
  <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
  ...
  public function CheckActiveUser($email){
    ...
    public function userLoginAuthotication($data){
      ...
      if ($email == "" || $password == "" ) {
        $msg = '<div class="alert alert-danger alert-dismissible mt-3" id="flash-msg">
  <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
  <strong>Error !</strong> Correo electrónico o contraseña no pueden estar vacía!</div>';
          return $msg;
  ...
  <strong>Error !</strong> Los campos de entrada no deben estar vacíos!</div>';
          ...
          $msg = '<div class="alert alert-danger alert-dismissible mt-3" id="flash-msg">
    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
    <strong>Error !</strong> El nombre de usuario es demasiado corto, al menos 3 caracteres !</div>';
            return $msg;
        }elseif (filter_var($mobile,FILTER_SANITIZE_NUMBER_INT) == FALSE) {
          $msg = '<div class="alert alert-danger alert-dismissible mt-3" id="flash-msg">
    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
  ...
  <strong>Error !</strong> Dirección de correo electrónico inválida !</div>';
        ...
        if ($result) {
          ...
          <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
          <strong>Success !</strong> Vaya, su información se actualizó con éxito!</div>');
    ...
    public function deleteUserById($remove){
      ...
      $stmt->bindValue(':id', $remove);
        ...
        if ($result) {
          $msg = '<div class="alert alert-success alert-dismissible mt-3" id="flash-msg">
    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
    <strong>Success !</strong> Cuenta de usuario eliminada con éxito !</div>';
            return $msg;
        }else{
          $msg = '<div class="alert alert-danger alert-dismissible mt-3" id="flash-msg">
    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
      ...
      $sql = "UPDATE tbl_users SET
       ...
       $result =   $stmt->execute();
        if ($result) {
          ...
          Session::set('msg', '<div class="alert alert-success alert-dismissible mt-3" id="flash-msg">
          <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
          <strong>Success !</strong> Cuenta de usuario desactivada con éxito !</div>');
    ...
    public  function changePasswordBysingelUserId($userid, $data){
      ...
      if ($old_pass == "" || $new_pass == "" ) {
        $msg = '<div class="alert alert-danger alert-dismissible mt-3" id="flash-msg">
  <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
  <strong>Error !</strong> El campo de la contraseña no debe estar vacío !</div>';
          return $msg;
